...
This might seem like an odd thing to do, but it actually comes up a lot in discussions of discrimination: people will advocate for examining disparities *after* controlling for things that (like job role) that are themselves downstream from discrimination. In a sense, this is telling people to "measure discrimination after controlling for discrimination"
