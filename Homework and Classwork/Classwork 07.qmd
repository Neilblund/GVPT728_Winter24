...
The average effect of changing from violence to non-violence is about an 11% increase in the probability of success.

For covariates that take on continuous values, you may instead want to calculate the effect of a one unit increase from the current values. For instance, to calculate the effect of moving every camp_size_est up by 1, I would run:
