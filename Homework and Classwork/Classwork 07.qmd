...
preds<-predict_response(model, 
                        ...
                        margin='empirical')  # marginalizing across 
...
preds<-predict_response(model2, 
                        terms=c("percent_pop[all]", "tactic"),  # prediction at all values of percent_pop
                        margin='empirical')  # with these values at 1 and 1
...
We can get predictions across all of these values with: 
