...
Load in some functions and code from the previous class: 
...
We can model heteroscedastic data by making the variance of $\epsilon$ depend on values of one of the predictors: 
